...
class CArreraDoc:
    ...
    def view(self):
        ...
        self.topMenu.add_command(label="aide", command=lambda: webbrowser.open(
        ...
        # widget settingCadre
        self.labelIndication1 = Label(self.settingCadre, text="Nombre de documentation afficher :", bg=color,
                                      font=("arial", "20"), fg=textColor)
        self.labelIndication2 = Label(self.settingCadre, text="Theme application :", bg=color, font=("arial", "20"),
                                      fg=textColor)
        ...
        self.btnValider = Button(self.settingCadre, text="Valider", font=("arial", "15"), width="25", bg="green",
                                 fg="white", command=self.ecriturePara)
        self.btnAdd = Button(self.settingCadre, text="Ajouter une documentation", font=("arial", "15"), width="25",
                             bg=color, fg=textColor, command=self.addPage)
        self.btnSuppr = Button(self.settingCadre, text="Supprimer une documentation", font=("arial", "15"), width="25",
                               bg=color, fg=textColor, command=self.supprDoc)
        self.btnBack1 = Button(self.settingCadre, text="Retour Acceuil", bg=color, fg=textColor, font=("arial", "15"),
                               width="25", command=lambda: self.mainAffichage(1))
        # widget addCadre
        self.btnOnline = Button(self.addCadre, text="En ligne", bg=color, fg=textColor, font=("arial", "15"),
                                command=self.onlineAdd)
        self.btnLocal = Button(self.addCadre, text="Local", bg=color, fg=textColor, font=("arial", "15"),
                               command=self.localAdd)
        self.btnBack2 = Button(self.addCadre, text="Retour Acceuil", bg=color, fg=textColor, font=("arial", "15"),
                               command=lambda: self.mainAffichage(1))
        # widget supprCadre
        self.labelIndication3 = Label(self.supprCadre, text="Choisissez le numero du bouton :", bg=color,
                                      font=("arial", "20"), fg=textColor)
        self.btnValSuppr = Button(self.supprCadre, text="Supprimer", font=("arial", "15"), width="25", bg="red",
                                  fg="white")
